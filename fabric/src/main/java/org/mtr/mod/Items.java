...
public final class Items {
	...
	static {
		...
		RAIL_CONNECTOR_HELICOPTER = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_helicopter"), itemSettings -> new Item(new ItemRailModifier(true, true, true, false, RailType.HELICOPTER, itemSettings)), CreativeModeTabs.CORE);
